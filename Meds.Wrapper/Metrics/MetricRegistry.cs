...
namespace Meds.Wrapper.Metrics
{
    public static class MetricRegistry
    {
        ...
        public static readonly HistogramFactory HistogramFactoryNotThreadSafe = HistogramFactory.With64BitBucketSize();
        public static readonly HistogramFactory HistogramFactory = HistogramFactoryNotThreadSafe.WithThreadSafeWrites();
