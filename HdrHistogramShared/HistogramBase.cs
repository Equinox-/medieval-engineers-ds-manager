...
namespace HdrHistogram
{
    ...
    public abstract class HistogramBase
    {
        ...
        public RecordedValuesEnumerable RecordedValues()
        {
        ...
        /// </summary>
        /// <returns>An enumerator of <see cref="HistogramIterationValue"/> through the histogram using a <see cref="RecordedValuesEnumerator"/></returns>
        public AllValueEnumerable AllValues()
        {
        ...
        public int GetEstimatedFootprintInBytes => (512 + (WordSizeInBytes * CountsArrayLength));
